      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Professional 24/7 emergency towing and roadside assistance in Tulsa, Oklahoma and surrounding areas. Licensed, insured, and trusted by thousands of customers.",
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-4">
          ...
          <p className="text-base md:text-xl mb-8 drop-shadow-md text-gray-200">
            Licensed • Insured • Military Discounts • Serving Tulsa & Surrounding Areas Since 2010
          </p>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900">15 Min</h3>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900">14 Years</h3>
